            ...
            (t.decode = function(t, e) {
              ...
              if (n) {
                ...
                try {
                  ...
                  throw new S("Error processing the " + c + " encoding, decoder returned Ã¢â‚¬Ëœ" + t.message + "Ã¢â‚¬â„¢", 40013, 400);
                } finally {
            ...
            a &&
              ...
              a("online", function() {
                (r.state != r.states.disconnected && r.state != r.states.suspended) ||
                  (b.logAction(b.LOG_MINOR, "ConnectionManager caught browser Ã¢â‚¬ËœonlineÃ¢â‚¬â„¢ event", "reattempting connection"), r.requestState({ state: "connecting" }));
              }),
              a("offline", function() {
                r.state == r.states.connected && (b.logAction(b.LOG_MINOR, "ConnectionManager caught browser Ã¢â‚¬ËœofflineÃ¢â‚¬â„¢ event", "disconnecting active transport"), r.disconnectAllTransports());
              }));
          }
          return (
        ...
        H = (function() {
          ...
          return (
            ...
            (l.prototype.createTokenRequest = function(e, n, i) {
              ...
              if (r) {
                ...
                if (u)
                  ...
                  } else i(new S("clientId canÃ¢â‚¬â„¢t be an empty string", 40012, 400));
            ...
            (l.prototype._userSetClientId = function(t) {
              ...
              if ("*" === t)
                throw new S(
                  'CanÃ¢â‚¬â„¢t use "*" as a clientId as that string is reserved. (To change the default token request behaviour to use a wildcard clientId, instantiate the library with {defaultTokenParams: {clientId: "*"}}), or if calling authorize(), pass it in as a tokenParam: authorize({clientId: "*"}, authOptions)',
                  40012,
                  400,
                );
        ...
        j = (function() {
          ...
          function n(t) {
            ...
            if ("clientId" in t) {
              ...
              if ("*" === t.clientId)
                throw new S(
                  'CanÃ¢â‚¬â„¢t use "*" as a clientId as that string is reserved. (To change the default token request behaviour to use a wildcard clientId, use {defaultTokenParams: {clientId: "*"}})',
                  40012,
                  400,
                );
            }
